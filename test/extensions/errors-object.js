...
// Create a Test Suite
vows
  .describe('Testing if errors() precisely informs about the cause')
  .addBatch({
    'Object : ': {
      topic: function() {
        return {
      ...
      Number: {
        ...
        'Object { test : Number }  : String was passed instead Number': function(
          t
        ) {
      ...
      String: {
        ...
        'Object { test : String }  : Boolean | Function | Object | Number was passed instead String': function(
          t
        ) {
          [
            t.input_invalid_boolean,
            t.input_invalid_function,
            t.input_invalid_number,
            t.input_invalid_object
          ].forEach(function(instance, index, array) {
            var validation = false === t.schema(instance);
            assert(
              !_.isString(instance.test),
              'Input nr ' +
            ...
            assert(
              ...
              'Validation is broken. Received input ' +
                vows.inspect(t.input_invalid_string) +
                ' should NOT be validated.'
            );
